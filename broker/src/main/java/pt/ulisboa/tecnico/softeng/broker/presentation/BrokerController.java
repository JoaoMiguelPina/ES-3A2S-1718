...
public class BrokerController {
	...
	public String brokerSubmit(Model model, @ModelAttribute BrokerData brokerData) {
		logger.info("brokerSubmit name:{}, code:{}, nifAsSeller:{}, nifAsBuyer:{}, iban:{}", brokerData.getName(), brokerData.getCode(), brokerData.getNifAsSeller(), brokerData.getNifAsBuyer(), brokerData.getIban());
